...
<meta name="description" content="This website based on JavaEE and FFmpeg" />

<title><s:property value="%{getText('website.title')}"/></title>
...
<div id="svw_main">
    ...
    <div id="content">
    	...
    	<p>This is the simplest demo about video website. it is based on JavaEE and FFmpeg.</p>
        ...
        <p>From this website the we can manage vedio server</p>
